...
[*]  Examples:
  ...
  [*] python -m slurm_gzip -d /path/to/files -s .txt .log --local-run --threads 4
...
def main():
    ...
    if args.slurm:
        ...
        print()
        print("To run:")
        print(f"  # Using threading: python -m slurm_gzip -s {' '.join(args.suffixes)} --local-run --threads 4")
